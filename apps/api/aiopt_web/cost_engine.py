...
class CostResult:
    input_cost:Decimal;output_cost:Decimal;cached_input_cost:Decimal;total_cost:Decimal;pricing_record_id:str
class CostCalculator:
    ...
    def calculate(self,provider,model,at,input_tokens,output_tokens,cached_input_tokens=0):
        ...
        return CostResult(input_cost,output_cost,cached_cost,input_cost+output_cost+cached_cost,price.id)
